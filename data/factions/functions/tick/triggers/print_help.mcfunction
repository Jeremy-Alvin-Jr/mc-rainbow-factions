...
tellraw @s [{"text":"/trigger factionsJoin","clickEvent":{"action":"suggest_command","value":"/trigger factionsJoin"},"color":"gray","italic":"true"},{"text":" - joins the faction if invited","color":"white","italic":"false"}]
